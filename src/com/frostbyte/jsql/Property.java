...
public class Property {
	...
	public Property(String name, Type type, String _default) {
		this.name = name;
		this.type = type;
		this._default = _default;
	}
	
	public Property(String name, Type type, boolean auto_incrementing){
		this.name = name;
		this.type = type;
		this.auto_incrementing = auto_incrementing;
	}
	...
	public enum Attributes {
		BINARY("BINARY"), UNSIGNED("UNSIGNED"), UNSIGNED_ZEROFILL("UNSIGNED ZEROFILL"), UPDATE_CURRENT_TIMESTAMP("on update CURRENT_TIMESTAMP");
